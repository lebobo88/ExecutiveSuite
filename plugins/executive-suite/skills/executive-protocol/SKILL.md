...
The shared operating protocol for all ExecutiveSuite C-suite agents. Every output from a single-domain executive or an orchestrator MUST conform to one of the templates below.
