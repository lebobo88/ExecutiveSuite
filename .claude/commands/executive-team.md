...
Read each `.claude/agents/*.md` (excluding orchestrators) and list:
...
### Skills (9)
List from `.claude/skills/*/SKILL.md`: name + description from frontmatter.

### Slash commands
List from `.claude/commands/*.md`: name + description.
